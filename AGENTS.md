...
2. **Use** `templates/PLAN_TEMPLATE.md`, `templates/TEST_PLAN_TEMPLATE.md`, `templates/DESIGN_BRIEF_TEMPLATE.md`, `templates/DEBUG_SESSION_TEMPLATE.md`, `templates/REFLECT_TEMPLATE.md`, and `templates/POSTMORTEM_TEMPLATE.md` when planning, testing, UI work, structured debugging, reflect, or incident write-ups respectively.
