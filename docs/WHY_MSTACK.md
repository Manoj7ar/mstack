...
- [SHARE_AND_COMPARE.md](SHARE_AND_COMPARE.md) — tell others; **`/mstack-pitch-short`** in Cursor  
- [DEMO_WALKTHROUGH.md](DEMO_WALKTHROUGH.md) — see the **whole** story in the mstack repo (optional Ideas API)  
