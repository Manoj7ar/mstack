...
**Quick links:** [DOCS_MAP.md](DOCS_MAP.md) · [ADOPTION_SCORECARD.md](ADOPTION_SCORECARD.md) · [SHARE_AND_COMPARE.md](SHARE_AND_COMPARE.md) · [BADGE.md](BADGE.md) · [DEMO_WALKTHROUGH.md](DEMO_WALKTHROUGH.md) · [SRC_INTERNAL.md](SRC_INTERNAL.md) · [GLOSSARY.md](GLOSSARY.md) · [ANTI_PATTERNS.md](ANTI_PATTERNS.md) · [CURSOR_MCP.md](CURSOR_MCP.md) · [WHY_MSTACK.md](WHY_MSTACK.md) · [STARTER_KIT.md](STARTER_KIT.md) · [RECIPES.md](RECIPES.md) · [SKILLS.md](SKILLS.md) · [CONTEXT_BUDGET.md](CONTEXT_BUDGET.md) · [CURSOR_BASE_BEHAVIOR.md](CURSOR_BASE_BEHAVIOR.md) · [TEAM_ROLLOUT.md](TEAM_ROLLOUT.md) · [RULES_SOURCE.md](RULES_SOURCE.md) · [VENDOR_UPGRADE.md](VENDOR_UPGRADE.md) · [MONOREPO.md](MONOREPO.md) · [ONBOARDING.md](ONBOARDING.md) · [PLAYBOOK.md](PLAYBOOK.md) · [POWER_USER.md](POWER_USER.md) · [TOKEN_LEVERS.md](TOKEN_LEVERS.md) · [CURSOR_INTEGRATION.md](CURSOR_INTEGRATION.md) · [EFFECTIVENESS.md](EFFECTIVENESS.md) · [SPECIALIST_MAP.md](SPECIALIST_MAP.md) · [ADOPTION_AUDIT.md](ADOPTION_AUDIT.md) · [PLAYBOOK_FIRST_MESSAGES.md](PLAYBOOK_FIRST_MESSAGES.md) · [SHOWCASE.md](SHOWCASE.md) · [FAQ.md](FAQ.md) · [GSTACK_INSPIRATION.md](GSTACK_INSPIRATION.md) · [TROUBLESHOOTING.md](TROUBLESHOOTING.md) · [CURSOR_LIMITS.md](CURSOR_LIMITS.md)
