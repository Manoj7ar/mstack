...
**Next:** experienced users — [POWER_USER.md](POWER_USER.md) (session file, CI verify, mechanical pass). **Token habits (honest)** — [TOKEN_LEVERS.md](TOKEN_LEVERS.md). Copy-paste chat openers — [PLAYBOOK_FIRST_MESSAGES.md](PLAYBOOK_FIRST_MESSAGES.md). Install checklist — [ADOPTION_AUDIT.md](ADOPTION_AUDIT.md). **Is this worth it for me?** — [EFFECTIVENESS.md](EFFECTIVENESS.md). **Trimming overlap** — [SPECIALIST_MAP.md](SPECIALIST_MAP.md).
